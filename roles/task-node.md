...
and follow only for concrete necessary work.

Derive your relation from Task facts, not memory: assignee is you means your Task,
orchestrator is you means your Subtask; when unsure, read the Task. The host supplies your
identity. Never self-assign or accept your own work.
...
subscription capability or a notification ACK. Never ACK/report automation. Self-`task_reopen` only
...
orchestrator work. Subtasks of your Task notify you when done, blocked or cancelled. Read only
