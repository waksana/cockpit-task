...
the current 0.1.8 preparation includes selective Task reads and updated Skill
guidance and supersedes installed 0.1.7; that installation remains immutable.
