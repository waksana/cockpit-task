...
test('schema 1 upgrade preserves Task rows and receipts while fencing old binaries with version 2', t => {
  const f = fixture(t), task = f.executable();
  ...
  old.exec('DROP TABLE subscriptions; PRAGMA user_version=1');
  old.close();
